...
export function HoldingsTable() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Ad Exchanges & Publisher Performance</CardTitle>
      </CardHeader>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              >
                Exchange / Network <SortIcon col="name" sortKey={sortKey} sortDir={sortDir} />
              </TableHead>
              <TableHead
                className="hidden cursor-pointer select-none text-right sm:table-cell"
                onClick={() => cycleSortDir("quantity")}
              >
                Slots (k) <SortIcon col="quantity" sortKey={sortKey} sortDir={sortDir} />
              </TableHead>
              <TableHead
                className="hidden cursor-pointer select-none text-right lg:table-cell"
                onClick={() => cycleSortDir("avgBuyPrice")}
              >
                Floor eCPM <SortIcon col="avgBuyPrice" sortKey={sortKey} sortDir={sortDir} />
              </TableHead>
              <TableHead
                className="cursor-pointer select-none text-right"
                onClick={() => cycleSortDir("currentPrice")}
              >
                Live eCPM <SortIcon col="currentPrice" sortKey={sortKey} sortDir={sortDir} />
              </TableHead>
              <TableHead
                className="cursor-pointer select-none text-right"
                onClick={() => cycleSortDir("plPct")}
              >
                Margin <SortIcon col="plPct" sortKey={sortKey} sortDir={sortDir} />
              </TableHead>
              <TableHead
                className="hidden cursor-pointer select-none text-right md:table-cell"
                onClick={() => cycleSortDir("plDollar")}
              >
                Yield Vol <SortIcon col="plDollar" sortKey={sortKey} sortDir={sortDir} />
              </TableHead>
