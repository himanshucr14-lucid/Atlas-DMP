...
const chartConfig: ChartConfig = {
  portfolio: { label: "Programmatic Impression Yield", color: "var(--color-chart-1)" },
  sp500: { label: "Industry Benchmark", color: "var(--color-chart-3)" },
}
    ...
    <Card>
      <CardHeader>
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          <CardTitle>Programmatic Impression Performance</CardTitle>
      ...
      <CardContent>
          ...
          <AreaChart data={data}>
            ...
            <ChartTooltip
              content={
                <ChartTooltipContent
                  formatter={(value) =>
                    `${Number(value).toLocaleString()} impr.`
                  }
                />
              }
            />
        ...
        <div className="mt-3 flex items-center justify-center gap-6 text-xs">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-muted-foreground">Programmatic Yield</span>
          </div>
          <div className="flex items-center gap-1.5">
