...
export function CardsPageClient() {
  ...
  return (
    <div className="space-y-6">
      {/* Row 1: Interactive card + 3D iPhone Preview + controls */}
      <div className="grid gap-6 lg:grid-cols-12 items-center">
        ...
        <div className="hidden sm:flex items-center justify-center lg:col-span-3">
          <IphoneDeviceMockup
            cardName={activeCard.name}
            last4={activeCard.last4}
            status={frozenMap[activeCardId] ? "Paused" : "Synced"}
