    ...
    <Card className="lg:col-span-4">
      <CardHeader>
        <div className="flex items-center gap-2">
          <CardTitle>DSP Exchange Distribution</CardTitle>
          <Badge variant="secondary" className="text-xs tabular-nums">
            {top3.length} Active DSP Pools
          </Badge>
        </div>
        <CardAction>
          <Badge
      ...
      <CardContent className="space-y-4">
        <p className="text-xs text-muted-foreground">
          RTB Clearing Share Distribution
        </p>
        ...
        <div className="space-y-1">
          {segments.map((seg) => {
            ...
            return (
              ...
              >
                <DataSourceLogo name={seg.coin.name} className="size-8" />
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent side="bottom" align="end">
                    <DropdownMenuItem>Increase Allocation</DropdownMenuItem>
                    <DropdownMenuItem>Pause Pool</DropdownMenuItem>
                    <DropdownMenuItem onSelect={() => onSelectCoin(seg.coin.id)}>View Clearing Curve</DropdownMenuItem>
                  </DropdownMenuContent>
                </DropdownMenu>
              </div>
            )
