      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="flex items-center gap-2.5 rounded-xl bg-emerald-50 px-3 py-2.5 dark:bg-emerald-950/30">
            ...
            <div>
              <p className="text-[10px] font-medium text-emerald-600/70 dark:text-emerald-400/70">Signals Ingested</p>
          ...
          <div className="flex items-center gap-2.5 rounded-xl bg-rose-50 px-3 py-2.5 dark:bg-rose-950/30">
            ...
            <div>
              <p className="text-[10px] font-medium text-rose-600/70 dark:text-rose-400/70">Fraud Filtered</p>
        ...
        <div className="flex items-center justify-between rounded-lg border px-3 py-2">
          <span className="text-xs text-muted-foreground">Net Clean Signals</span>
