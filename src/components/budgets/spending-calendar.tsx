    ...
    <Card>
      <CardHeader>
        <CardTitle className="text-base font-semibold">
          Daily Signal Processing Stream
        </CardTitle>
      </CardHeader>
      <CardContent>
        {/* Day headers */}
              ...
              {week.map((cell, ci) => {
                ...
                return (
                  ...
                  >
                    ...
                    {cell.amount > 0 && (
                      <span className="hidden text-[9px] tabular-nums text-muted-foreground sm:inline font-mono">
                        {Math.round(cell.amount / 10).toLocaleString()}k
                      </span>
                    )}
                  </div>
                )
