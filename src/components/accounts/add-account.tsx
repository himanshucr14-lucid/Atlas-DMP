...
const accountTypes = [
  { value: "checking", label: "SDK Integration" },
  { value: "savings", label: "CRM Connector" },
  { value: "crypto", label: "Pixel Pipeline" },
  { value: "investment", label: "First-Party Data" },
] as const
  ...
  function handleConnect() {
    ...
    setTimeout(() => {
      const newAccount: BankAccount = {
        ...
        accountNumber: `SRC-${accountNumber.slice(-4)}`,
        balance: 0,
        currency: "SIG",
        change: 0,
        changePercent: 0,
      ...
      <CardContent className="flex w-full flex-col items-center justify-center">
        <AnimatePresence mode="wait">
          ...
          {step === "form" && (
            ...
            >
              <Input
                placeholder="Data source name / URL"
                value={institution}
              ...
              <Input
                placeholder="API key / integration ID"
                value={accountNumber}
